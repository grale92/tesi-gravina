...
Il processo genera nella cartella indicata di output una directory contenente i vari modelli ottenuti nel ciclo di addestramento, con una \texttt{model\_best} contenente la configurazione con le migliori prestazioni ottenute sui dati di valutazione.
