...
\begin{itemize}
    ...
    \item \textbf{Tracciabilità delle verifiche e dei test eseguiti}. È fondamentale garantire la tracciabilità delle prove effettuate su ciascun articolo e prodotto, associando in modo univoco i test eseguiti, i metodi di prova, il laboratorio responsabile e i test eseguiti, al fine di supportare l'attività di controllo e di facilitare la ricostruzione dello storico.
...
\begin{itemize}
    ...
    \item \textbf{Pianificazione, scadenze, rinnovi e alert}. Il sistema può gestire scadenze e rinnovi dei certificati con appositi alert pre-configurati, oltre alla generazione automatica di prove di controllo qualità per un articolo o un prodotto in base ai dati recuperati in anagrafica.
...
\begin{itemize}
  ...
  Il progetto mira a rendere il sistema informativo più adatto a gestire un numero crescente di documenti, articoli e prodotti, ponendo le basi per una gestione più strutturata e sostenibile della documentazione tecnica nel medio e lungo periodo.
\end{itemize}