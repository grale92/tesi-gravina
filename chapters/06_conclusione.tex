...
\begin{itemize}
    ...
    \item \textbf{Miglioramento dell'integrazione con i dati aziendali}, utilizzando tecniche di recupero semantico basate su embedding vettoriali, per aumentare la robustezza della fase di matching e ridurre il numero di interventi manuali per la validazione dei risultati.
\end{itemize}
